							...
							<form role="form" method="POST" action="agregar.php" enctype="multipart/form-data">
                               <?php if(isset($id)){ echo "<input type='hidden' value='$fila->idalumnos' name='id'>"; }?>
								...
								<div class="form-group">
									...
									<input type="Text" name="nombre" class="form-control" placeholder="nombres y apellidos" pattern="[A-Za-z_ ]{1,15}"
									oninvalid="setCustomValidity('Ingrese solo letras')" 
									oninput="setCustomValidity('')" 
									 required value="<?php  if(isset($id)){echo  $fila->nombrealumno;} ?>">
								</div>
								...
								<div class="form-group">
									...
									<input type="mobile" name="telefono" pattern="[0-9]{9}" class="form-control" oninvalid="setCustomValidity('Ingrese solo 9 numeros')" 
									oninput="setCustomValidity('')"
									required value="<?php  if(isset($id)){echo  $fila->telefonoa;} ?>"
                  >
								</div>
									<div class="form-group">
									<label>Tel de Emergencia</label>
									<input type="mobile" name="emergencia" pattern="[0-9]{9}" class="form-control"
									oninvalid="setCustomValidity('Ingrese solo 9 numeros')" 
									oninput="setCustomValidity('')" 
									required value="<?php  if(isset($id)){echo  $fila->emergencia;} ?>">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									placeholder="nombres y apellidos del tutor" pattern="[A-Za-z_ ]{1,15}"
									oninvalid="setCustomValidity('Ingrese solo letras')" 
									oninput="setCustomValidity('')"
									 required value="<?php  if(isset($id)){echo  $fila->tutor;} ?>">
								</div>
								<div class="form-group">
